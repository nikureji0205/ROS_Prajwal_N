...
image_name = "blackwhite_praj"

print("read an image from file ")
img = cv2.imread("/home/praj/catkin_ws/src/ros_basics_tutorials/src/perception_I/images/"+image_name+".jpg")

print("display the content of the image")
print(img)
print("in python , an image is store in numpy array. Numpy is library used for scientific computing of multi-dimensional arrays and matrices.")
...
print("weight = %d"%width)
print("channel = %d"%channels)
